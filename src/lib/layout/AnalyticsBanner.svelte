...
<script>
  ...
  function initAnalytics() {
    ...
    if ($page)
      location = `${$page.url.protocol}//${$page.url.hostname}${$page.url.pathname}`;
          ...
          <div>
            <div class="cookies-banner__message font-size--18">
              ...
              <p class="cookies-banner__body">
                We would like to use cookies to collect anonymous information
            ...
            <div class="cookies-banner__buttons">
              <div
                class="cookies-banner__button cookies-banner__button--accept"
              >
                <button
