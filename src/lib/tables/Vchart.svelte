...
<ul class="legend-block">
	...
	<li class:ew={i != 0}>
		<div class="legend-vis {i == 0 ? 'bar' : 'marker'}" style:height="1rem" style:width="{i == 0 ? '1rem' : 3 + 'px'}"></div>
...
<h3 style='font-size:.9rem;font-weight:bold'> Population ({name[0]}): <span style='font-size:0.85rem;font-weight:300'>{sum(population[0])} people</span></h3>

<h3 style='font-size:.9rem;font-weight:bold'> Mean Age ({name[0]}): <span style='font-size:0.85rem;font-weight:300'>{histomean(population[1],population[0]).toFixed(2)} years</span></h3>
