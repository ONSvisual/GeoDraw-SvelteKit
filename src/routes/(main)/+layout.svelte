...
<svelte:head>
  ...
  <meta property="og:title" content="Build a subnational profile - ONS" />
  <meta property="og:type" content="website" />
	...
	<meta property="og:description" content="Create your own profile for local areas in the UK using ONS data." />
	<meta name="description" content="Create your own profile for local areas in the UK using ONS data. Data topics include population, age, sex, ethnicity, religion, the work people do, and the homes they live in." />
</svelte:head>
