<script>
  ...
  onMount(async () => {
    ...
    window.d = await dfd
      .readCSV(
        // `https://www.nomisweb.co.uk/api/v01/dataset/${ncode}.bulk.csv?date=latest&geography=MAKE|MyCustomArea|${state.compressed},K04000001&rural_urban=0&measures=20100&select=geography_name,cell_name,obs_value`
